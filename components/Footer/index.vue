    ...
    <section class="bg-white text-black">
      <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-8 space-x-6">
          <a href="https://www.facebook.com/profile.php?id=61555018767781" class="text-gray-400 hover:text-gray-500"
            target="_blank">
          ...
          <a href="https://www.instagram.com/menuiserie.gibilaro/?igsh=d3E2MWh3eDV0YmMz&utm_source=qr&fbclid=IwAR08BN-U_iU-Nhuc-eVAnQABNKDhNPJiYcyfs-JqPZSvj2Ti27MtCon5_gc"
          ...
          <a href="https://github.com/Reptilz" class="text-gray-400 hover:text-gray-500" target="_blank">
