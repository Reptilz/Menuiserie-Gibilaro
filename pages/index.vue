...
<footer
  ...
  <div class="container pt-0">
    <div class="mb-4 flex justify-center">
      <a href="https://www.facebook.com/profile.php?id=61555018767781" class="mr-9 text-neutral-800 dark:text-neutral-200">
        <svg
      ...
      <a href="https://github.com/Reptilz/Menuiserie-Gibilaro" class="text-neutral-800 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
  ...
  <!--Copyright section-->
  <div
    class="w-full bg-neutral-300 px-4 py-0 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
    Created with ♡ by
    <a
